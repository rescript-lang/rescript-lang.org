...
let element = JsxRuntime.jsx("div", {
  children: "Hello " + name,
});
...
let render = (myComp: React.component<props>) => {
...
let render = (article: React.component<props>) => {
...
function render(article) {
  let children = ["Introduction", "Body"];
  let props = {
    title: "Article #1",
    children: null,
  };
...
let original = JsxRuntime.jsx("div", {
  className: "hello",
});
