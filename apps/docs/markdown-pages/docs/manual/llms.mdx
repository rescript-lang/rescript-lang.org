...
- [v12 current build system](/llms/manual/v12/build-system/llm.txt) - focused current ReScript v12 build system reference.
- [v12 current getting started](/llms/manual/v12/getting-started/llm.txt) - focused current ReScript v12 onboarding reference.
