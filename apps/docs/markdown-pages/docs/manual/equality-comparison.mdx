...
canonical: "/docs/manual/equality-comparison"
...
export { t1, t2, t3, doStringsMatch };
```
...
let compareArray = Primitive_object.greaterthan;

let compareOptions = Primitive_object.lessthan;

let t1 = false;

export { compareInt, t1, compareArray, compareOptions };
```
