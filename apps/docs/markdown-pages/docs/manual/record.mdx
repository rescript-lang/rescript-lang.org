...
```res
type matchedOptionalPerson = {
  age: int,
  name?: string,
}

let me: matchedOptionalPerson = {
  age: 123,
  name: "Hello",
}
...
```res
type matchedOptionalRecord = {
  age: int,
  name?: string,
}

let me: matchedOptionalRecord = {
  age: 123,
  name: "Hello",
}
...
Why use records instead of objects?
