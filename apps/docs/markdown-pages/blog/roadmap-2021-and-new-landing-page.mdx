...
It has almost been a year since we originally [launched our new ReScript brand](./bucklescript-is-rebranding.mdx), and we think it has been a pretty successful journey so far:
...
The detailed roadmap with all our planned changes (and definition of our release cycle plan) can be found in our [community / roadmap](../community/roadmap.mdx) section.
