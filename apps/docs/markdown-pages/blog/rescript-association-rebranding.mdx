...
Last year, our platform rebranded from BuckleScript and Reason to [ReScript](./bucklescript-is-rebranding.mdx). The Reason Association however, due to administrative reasons, lagged behind in name change until recently.
