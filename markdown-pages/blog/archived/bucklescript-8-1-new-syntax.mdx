...
- There are a few differences in syntax between the Reason syntax, documented in the [migration docs](https://v11.rescript-lang.org/docs/manual/v8.0.0/migrate-from-bucklescript-reason).
