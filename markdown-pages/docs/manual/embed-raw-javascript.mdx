...
canonical: "/docs/manual/embed-raw-javascript"
...
This makes incremental adoption straightforward -- existing JavaScript code can live inside ReScript files during migration.
