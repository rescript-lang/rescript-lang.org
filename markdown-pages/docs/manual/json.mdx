...
Use [`JSON.stringify`](https://rescript-lang.org/docs/manual/api/latest/stdlib/json#value-stringify) if your data is of type `JSON.t` or [`JSON.stringifyAny`](https://rescript-lang.org/docs/manual/api/latest/stdlib/json#value-stringifyAny) if it is not.
