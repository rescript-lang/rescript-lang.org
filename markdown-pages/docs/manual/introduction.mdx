...
ReScript code can be [imported into JavaScript code](/docs/manual/import-from-export-to-js#export-to-javascript), can [generate types for TypeScript](/docs/manual/typescript-integration), and ReScript can [import code written in JavaScript or TypeScript](/docs/manual/import-from-export-to-js#import-from-javascript).
