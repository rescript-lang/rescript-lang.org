...
Then it's not really an object, it's a hash map. Use [Dict](https://rescript-lang.org/docs/manual/api/latest/stdlib/dict), which contains operations like `get`, `set`, etc. and cleanly compiles to a JavaScript object still.
