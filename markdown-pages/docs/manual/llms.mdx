...
- [/docs/manual/llms.txt](https://rescript-lang.org/llms/manual/llms.txt) — a list of the available files for ReScript language.
- [/docs/manual/llm-full.txt](https://rescript-lang.org/llms/manual/llm-full.txt) — complete documentation for ReScript language.
- [/docs/manual/llm-small.txt](https://rescript-lang.org/llms/manual/llm-small.txt) — compressed version of the former, without examples.
