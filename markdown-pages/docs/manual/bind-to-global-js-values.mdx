...
**First**, make sure the value you'd like to model doesn't already exist in our [provided API](https://rescript-lang.org/docs/manual/api/latest/stdlib).
...
(We already provide `setTimeout`, `clearTimeout` and others in the [Core API](https://rescript-lang.org/docs/manual/api/latest/stdlib) module).
