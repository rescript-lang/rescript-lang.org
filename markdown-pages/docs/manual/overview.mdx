...
| `3.0 +. 4.5`        | Float addition            |
| `2 / 3 * 4`         | Integer division/multiply |
| `2.0 /. 3.0 *. 4.0` | Float division/multiply   |
| `2.0 ** 3.0`        | Float exponentiation      |
| `5 % 3`             | Integer modulo            |

Integer and float are distinct types with separate arithmetic operators.
...
| Integer Division/Multiply | `2 / 23 * 1`                         | `2 / 23 * 1`                               |
