...
Search `rescript`-related packages on NPM, or use our [Package Index](https://rescript-lang.org/packages).
...
- You also have access to the familiar [Core API](https://rescript-lang.org/docs/manual/api/latest/stdlib).
