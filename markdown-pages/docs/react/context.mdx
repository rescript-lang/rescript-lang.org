...
Context provides a way to pass data through the component tree without having to pass props down manually at every level. See the [JSX](../../../docs/manual/jsx.mdx) docs for more details.
...
**Note:** In ReScript, passing down props is way simpler than in TS / JS due to its [JSX prop punning](/docs/manual/jsx#punning) feature and strong type inference, so it's often preferrable to keep it simple and just do props passing. Less magic means more transparency!
