...
Sometimes, when doing a lot of interop with existing ReactJS codebases, you'll find yourself in a situation where you can't use JSX syntax due to syntactic restrictions. For a more detailed description of how those functions work, please refer to the [JSX](../../../docs/manual/jsx.mdx) documentation.
...
In ReScript, we rather pass down required props explicitly to leaf components or use a renderProp instead. We introduced [JSX punning](/docs/manual/jsx#punning) syntax to make the process of passing down props more convenient.
