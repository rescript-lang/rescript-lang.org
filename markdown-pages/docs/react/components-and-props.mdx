...
function _tempFile$Greeting(props) {
  return Stdlib_Option.getOr(props.name, "");
}

let Greeting = {
  make: _tempFile$Greeting,
};

let name = "Andrea";

JsxRuntime.jsx(_tempFile$Greeting, {
  name: name,
});
...
function _tempFile$MyList(props) {
...
let MyList = {
  make: _tempFile$MyList,
};

JsxRuntime.jsxs(_tempFile$MyList, {
  children: [
    JsxRuntime.jsx("li", {
      children: "Item 1",
    }),
...
function _tempFile(props) {
  return JsxRuntime.jsx("div", {
    children: JsxRuntime.jsx(_tempFile$Greeting, {}),
  });
}
