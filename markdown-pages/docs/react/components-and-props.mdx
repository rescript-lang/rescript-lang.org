...
In ReactJS, props are usually described as a single `props` record. In ReScript, we use [labeled arguments](/docs/manual/function#labeled-arguments) to define our props parameters instead. Here's an example:
