...
canonical: "/docs/react/introduction"
section: "Overview"
order: 1
---
...
All our documented examples can be compiled in our [ReScript Playground](https://rescript-lang.org/try) as well.
...
- [GenType](../manual/typescript-integration.mdx) support for importing / exporting React components in TypeScript codebases
