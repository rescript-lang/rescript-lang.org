...
Learn more about [records](../../../docs/manual/record.mdx), [variants](../../../docs/manual/variant.mdx), and [pattern matching & destructuring](../../../docs/manual/pattern-matching-destructuring.mdx).
