...
function Example(props) {
  ...
  let focusInput = () => {
    let dom = textInput.current;
    if (dom == null) {
      return;
    }
    dom.focus();
  };
  let onClick = (param) => focusInput();
  return JsxRuntime.jsxs("div", {
    children: [
      JsxRuntime.jsx("input", {
        ref: Primitive_option.some(textInput),
        type: "text",
      }),
      JsxRuntime.jsx("input", {
        type: "button",
...
function Example(props) {
  ...
  return (
    <div>
      <input ref={Primitive_option.some(textInput)} type={"text"} />
      <input type={"button"} value={"Focus the text input"} onClick={onClick} />
    </div>
  );
}
...
function Example(props) {
  let textInput = React.useRef(null);
  return JsxRuntime.jsx(Example$MyComp, {
    ref: textInput,
  });
}
...
function Example(props) {
  let textInput = React.useRef(null);
  return <MyComp.make ref={textInput} />;
}
...
function Example$CustomTextInput(props) {
  return JsxRuntime.jsx("div", {
    children: JsxRuntime.jsx("input", {
      ref: Primitive_option.some(props.setInputRef),
      type: "text",
    }),
  });
}
...
function Example(props) {
  ...
  return JsxRuntime.jsx(Example$CustomTextInput, {
...
function Example$CustomTextInput(props) {
  return (
    <div>
      <input ref={Primitive_option.some(props.setInputRef)} type={"text"} />
    </div>
  );
}
...
function Example(props) {
  ...
  return <CustomTextInput.make setInputRef={setInputRef} />;
}
