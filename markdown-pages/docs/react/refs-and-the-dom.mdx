...
function _tempFile$MyComp(props) {
  return JsxRuntime.jsx("input", {});
}

let MyComp = {
  make: _tempFile$MyComp,
};

function _tempFile(props) {
  let textInput = React.useRef(null);
  return JsxRuntime.jsx(_tempFile$MyComp, {
    ref: textInput,
  });
}
...
function _tempFile$CustomTextInput(props) {
...
let CustomTextInput = {
  make: _tempFile$CustomTextInput,
};
...
function _tempFile(props) {
  ...
  return JsxRuntime.jsx(_tempFile$CustomTextInput, {
