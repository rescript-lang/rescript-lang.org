...
Add the following dependency to your ReScript project (in case you don't have any project yet, check out the [installation instructions](/docs/manual/installation)):
...
**Note:** In case your dependencies are not compatible with version 4 of the ReScript JSX transformation yet, you can use v3 in the same project. Check out the details in [Migrate from v3](/docs/react/migrate-react).
