...
[GenType](/docs/manual/typescript-integration) is a code generation tool for automatically generating [TypeScript](https://www.typescriptlang.org/) type definitions, and JS runtime converters for non-shared ReScript values. It also features first-class support for [rescript-react](/docs/react/latest/introduction) components.
...
- [TypeScript Integration](/docs/manual/typescript-integration)
