...
> Note that this operator has been deprecated. See [Triangle Pipe](../docs/manual/pipe.mdx#triangle-pipe-deprecated) for more details.
...
- [Triangle Pipe](../docs/manual/pipe.mdx#triangle-pipe-deprecated)
