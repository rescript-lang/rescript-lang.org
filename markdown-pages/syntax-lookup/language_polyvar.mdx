...
[Polymorphic variants](/docs/manual/polymorphic-variant) (or _poly variants_) are the structurally typed equivalent of [variants](/docs/manual/variant).
...
- [Polymorphic Variant](/docs/manual/polymorphic-variant)
