...
[Polymorphic variants](../docs/manual/polymorphic-variant.mdx) (or _poly variants_) are the structurally typed equivalent of [variants](../docs/manual/variant.mdx).
...
- [Polymorphic Variant](../docs/manual/polymorphic-variant.mdx)
