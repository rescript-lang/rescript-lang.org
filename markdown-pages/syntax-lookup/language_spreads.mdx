...
Read more about [record type spreads here](../docs/manual/record.mdx#record-type-spread).
...
Read more about [record immutable updates here](../docs/manual/record.mdx#immutable-update).
...
Read more about [variant type spreads](../docs/manual/variant.mdx#variant-type-spreads) here.
...
Read more about [variant type spreads in pattern matching](../docs/manual/pattern-matching-destructuring.mdx#match-on-subtype-variants).
...
See [Pattern Matching / Destructuring](../docs/manual/pattern-matching-destructuring.mdx) for more details.
...
Read more about [immutable list updates](../docs/manual/array-and-list.mdx#immutable-prepend) here.
...
Read more about [pattern matching on lists](../docs/manual/pattern-matching-destructuring.mdx#match-on-list).
...
Read more about [array spreads](../docs/manual/array-and-list.mdx#array-spreads).
...
Read more about [partial application of functions](../docs/manual/function.mdx#partial-application).

### References

- [Record type spreads](../docs/manual/record.mdx#record-type-spread)
- [Record immutable updates](../docs/manual/record.mdx#immutable-update)
- [Variant type spreads](../docs/manual/variant.mdx#variant-type-spreads)
- [Variant type spreads in pattern matching](../docs/manual/pattern-matching-destructuring.mdx#match-on-subtype-variants)
- [Pattern matching and polymorphic variants](../docs/manual/polymorphic-variant.mdx#combine-types-and-pattern-match)
- [List immutable updates](../docs/manual/array-and-list.mdx#immutable-prepend)
- [List pattern matching](../docs/manual/pattern-matching-destructuring.mdx#match-on-list)
- [Array spreads](../docs/manual/array-and-list.mdx#array-spreads)
- [Partial application of functions](../docs/manual/function.mdx#partial-application)
