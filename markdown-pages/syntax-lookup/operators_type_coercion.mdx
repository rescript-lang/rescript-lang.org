...
The `:>` operator may be used to convert a polymorphic variant to a `string` or `int`, or convert an [object](/docs/manual/object) to a type with a subset of its fields.
...
- [Int-to-Float Coercion](/docs/manual/primitive-types#int-to-float-coercion)
- [Variant Coercion](/docs/manual/variant#coercion)
- [Polymorphic Variant Coercion](/docs/manual/polymorphic-variant#coercion)
- [Record Type Coercion](/docs/manual/record#record-type-coercion)
