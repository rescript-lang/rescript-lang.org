...
> See [Convert Record Type to Abstract Record](/docs/manual/generate-converters-accessors#convert-record-type-to-abstract-record) for more details.
...
- [Convert Record Type to Abstract Record](/docs/manual/generate-converters-accessors#convert-record-type-to-abstract-record)
