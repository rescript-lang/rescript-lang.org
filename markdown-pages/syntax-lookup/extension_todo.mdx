...
This will crash when executed. We suggest to [promote the warning to an error](/docs/manual/build-overview#compile-with-stricter-errors-in-ci) when building for production.

### References

- [Stricter compilation in CI](/docs/manual/build-overview#compile-with-stricter-errors-in-ci)
- [Extension Point Attributes](/docs/manual/attribute#extension-point)
