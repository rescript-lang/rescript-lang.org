...
Types may be declared with [type parameters](/docs/manual/type#type-parameter-aka-generic) (also known as _generics_ in other languages) to create generalized versions of those types.
...
- [Type parameters](/docs/manual/type#type-parameter-aka-generic)
