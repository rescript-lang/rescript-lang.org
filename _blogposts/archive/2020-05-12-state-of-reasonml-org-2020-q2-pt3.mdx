...
<Image src="/blog/archive/search-mockup.jpg" withShadow={true} caption="A unified search overlay mockup for prose & API content" />
...
<Image src="/blog/archive/playground-mockup.jpg" withShadow={true} caption="UI mockup for the new playground (Desktop version)" />
