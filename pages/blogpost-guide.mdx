...
<Intro>
  Here you can find all the information needed to write and publish a new blog
  post on rescript-lang.org.
</Intro>
...
All blog posts that are put into the `_blogposts/archive` directory will be flagged as _archived_ and not show up on the blog overview page.
